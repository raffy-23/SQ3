<div class="sq-dashboard-layout">
    <section class="sq-dashboard-feed-column">
        <div class="sq-dashboard-composer sq-post-card-v2">
        ...
        <div class="sq-dashboard-feed-scroll" data-infinite-feed data-next-url="<?= esc((string) ($nextPageUrl ?? '')) ?>" >
            <div id="dashboard-post-list" class="sq-dashboard-post-list" data-empty-message="Your feed is empty. Follow people to see their posts!">


                <?= view('partials/post_cards', ['posts' => $posts ?? [], 'authUser' => $authUser ?? null]) ?>
            </div>

            <div class="sq-dashboard-feed-status" data-feed-sentinel>
    ...
    <aside class="sq-dashboard-side-column">
